...
public class EditorString  implements Editor  {
  ...
  private static Image       ICOK      = new Image(
                                           ...
                                           16,
                                           Utils
                                               .stringToBytes8("\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u000c\u0000\u0006\u0000\u0003\u0080\u0001\u00c0\u0000\u0061\u0000\u0033\u0000\u001e\u0000\u000c\u0000\u0000\u0000\u0000\u0000\u0000\u0000"));
  private static Image       ICDEL     = new Image(
                                           12,
                                           16,
                                           Utils
                                               .stringToBytes8("\u0000\u0000\u0000\u0000\u0000\u0000\u00f0\u000f\u00f8\u000f\u00dc\r\u00be\u000e\u007f\u000f\u00be\u000e\u00dc\r\u00f8\u000f\u00f0\u000f\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000"));
  ...
  private static Image       ICSHIFTON = new Image(
                                           ...
                                           16,
                                           Utils
                                               .stringToBytes8("\u0000\u0000\u0000\u0000\u0060\u0000\u00f0\u0000\u00f8\u0001\u00fc\u0003\u00fe\u0007\u00fe\u0007\u00f8\u0001\u00f8\u0001\u00f8\u0001\u00f8\u0001\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000"));
  private static Image       ICSYMBOL  = new Image(
                                           12,
                                           16,
                                           Utils
                                               .stringToBytes8("\u0000\u0000\u0082\u0001\u00c3\u0003\u0063\u0007\u0033\u0006\u0033\u000c\u0003\u000c\u0003\u000c\u0003\u0006\u0003\u0003\u0083\u0001\u0083\u0001\u0083\u0001\u0000\u0000\u0000\u0000\u0083\u0001"));

  private static GraphicsLCD lcd       = LocalEV3.get().getGraphicsLCD();

  private static String[][]  keyboards = { { "1234567890?", "qwertyuiop<", "asdfghjkl.>", "^zxcvbnm  ^" },
 ...
 public static String editValue() {
   ...
   do {
     ...
     if (str.length() > maxChars) {
       ...
       lcd.drawString("<", 16, 38, GraphicsLCD.BOTTOM | GraphicsLCD.RIGHT);
     }
     lcd.drawString(substr, 15, 38, GraphicsLCD.BOTTOM);
     lcd.drawString(" ", 15 + lcd.getFont().stringWidth(substr), 38, GraphicsLCD.BOTTOM, true);
     ...
     for (int yi = 0; yi < 4; yi++) {
       for (int xi = 0; xi < 11; xi++) {
         ...
         if (sx == xi && sy == yi && !(sy == 3 && sx >= 8 && sx <= 9))
           lcd.drawRegionRop(null, x - 1, y, chWidth + 2, chHeight, x - 1, y, 0, GraphicsLCD.ROP_COPYINVERTED);
       }
     }
     lcd.refresh();
     switch (UI.getUI()) {
     ...
     case Button.ID_ENTER:
       if (sy == 3 && (sx == 0 || sx == 10)) { // Shift Key Pressed
         if (keyboard == 0)
           ...
           keyboard = 0;
       } else if (sy == 2 && sx == 10) { // Symbols Key Pressed
         if (keyboard != 2)
           keyboard = 2;
         else
           keyboard = 0;
       } else if (sy == 0 && sx == 10) { // Backspace Key Pressed
         if (str.length() > 0)
